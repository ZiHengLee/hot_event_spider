...
import os
import utils
from development import BASE_ZHIHU_URL,DINGURL

from lxml import etree
import requests


JSON_DIR = os.getcwd()+'/raw/zhihu'
ARCHIVE_DIR = os.getcwd()+'/archives/zhihu'
READ_FILE = os.getcwd()+'/ZHIHU_README.md'
...
def worker():
    url = '/billboard'
    try:
        content = getHTML(BASE_ZHIHU_URL + url)
